---
{"dg-publish":true,"dg-path":"Blog Posts/How I take Notes.md","permalink":"/blog-posts/how-i-take-notes/","tags":["blogs"],"created":"2025-06-11","updated":"2026-03-03","dg-note-properties":{"created":"2025-06-11","tags":"blogs","modified":"2026-03-03","related":null}}
---


This vault serves as my **Digital Garden** and **Personal Knowledge Management System**. Each file represents a distinct object with specific purposes, relationships, and metadata.  
The system is designed around the principle that **everything is connected** and **context is king**.
...
- Tags are used exclusively for vault meta

A single file can represent multiple Object Types, or have Meta Types as well as Object Types
...
| `#books`          | Reference book notes and reviews.                                                                                     |
| `#blogs`          | Blog posts... for my blog                                                                                             |
| `#companies`      | Companies I have worked with, or have some other tie too.                                                             |
| `#daily`          | Daily Notes. Mostly unused                                                                                            |
| `#events`         | Events I have attended, like Conferences or Weddings                                                                  |
| `#how-tos`        | Simple Problem / Solution notes for fixing a problem or completing a task. Output from other notes like the Workbooks |
| `#meetings`       | Meeting notes that link dates, workbooks, people etc.                                                                 |
| `#mocs`           | Map of Contents, usually sparse in their own content, but are content hubs.                                           |
...
| Tag           | Description                                                                        |
| ------------- | ---------------------------------------------------------------------------------- |
| `#excalidraw` | Shows that the file is managed by Excalidraw.                                      |
| `#locations`  | Pointer to show that the Object has Properties to have it appear in my Bases maps. |
| `#slides`     | Shows that the file is formatted to work with Obsidian Slides or MAPs.             |

#### Archived Tags

| Tag        | Description                                                                                                                                                        |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `#worklog` | Used as an experiment to tag information in Daily Notes to surface other places (LogSec outliner styled), but was not efficient / did not match Obsidians workflow |
...
> [!Note]  
> There are lots of metadata frontmatter fields that are plugin managed. The list below are just the ones that the human works with.
...
| coordinates | A sting for the Longitude and Latitude to use for the Icon in Bases map view                                |
...
| email       | A string used for contact information.                                                                      |
...
| tags        | A key field that defines the Object Type via tags and Meta                                                  |
