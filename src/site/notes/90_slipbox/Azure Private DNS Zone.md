---
{"dg-publish":true,"permalink":"/90-slipbox/azure-private-dns-zone/","tags":["notes"],"created":"2026-03-27T09:57:51.488+10:30","updated":"2026-06-11T09:30:38.361+09:30","dg-note-properties":{"created":"2023-05-15","modified":"2026-06-11","references":["https://learn.microsoft.com/en-us/azure/dns/private-dns-overview","https://learn.microsoft.com/en-us/azure/dns/private-dns-virtual-network-links"],"related":["[[Azure]]"],"tags":"notes"}}
---
...
This works by linking to one or many [[90_slipbox/Azure Virtual Network\|Virtual Networks]], and the DNS Server on the Virtual network needs to be configured to look up against the [[90_slipbox/Azure Magic IP\|Azure Magic IP]], either by default or by the custom DNS server.

Auto Registration can be enabled on a Link to a VNET, but each VNET can only have Auto Registration enabled once. This service allows for [[90_slipbox/Azure Virtual Machine\|VMs]] to be discoverable on a custom domain.
...
Private DNS Zones can be created with the same name as long as they are in different resource groups. This is a common occurrence with [[90_slipbox/Azure Private Link\|Private Links]], and should be considered upfront.
