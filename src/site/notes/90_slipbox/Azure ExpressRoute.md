---
{"dg-publish":true,"permalink":"/90-slipbox/azure-express-route/","tags":["notes"],"created":"2026-03-27T09:57:51.490+10:30","updated":"2026-03-27T09:57:51.490+10:30","dg-note-properties":{"tags":"notes","related":["[[Azure]]"],"created":"2024-05-15","modified":"2026-03-03"}}
---
...
ExpressRoute is a [[90_slipbox/OSI Networking Model#Layer 3 - Network\|Layer 3 Connection]] between your on-premises network and the Microsoft cloud. This connection can be an **any-to-any IPVPN**, **point-to-point Ethernet connection**, or a **virtual cross-connection via Ethernet Exchange**.  
![Azure ExpressRoute-1721177475219.png](/img/user/10_attachments/Azure%20ExpressRoute-1721177475219.png)
...
> When Microsoft peering gets configured on your ExpressRoute circuit, the Microsoft Edge routers establish a pair of [[90_slipbox/Border Gateway Protocol\|Border Gateway Protocol]] (BGP) sessions with your edge routers through your connectivity provider. No routes are advertised to your network. To enable route advertisements to your network, you must associate a [[90_slipbox/Azure Route Filter\|Azure Route Filter]].  
...
![Azure ExpressRoute-1721181255378.png](/img/user/10_attachments/Azure%20ExpressRoute-1721181255378.png)
...
![Azure ExpressRoute-1721608364354.png](/img/user/10_attachments/Azure%20ExpressRoute-1721608364354.png)
...
FastPath is available on all ExpressRoute circuits, and requires a [[90_slipbox/Azure Virtual Network Gateway\|Azure Virtual Network Gateway]] with either **Ultra-Performance** or **ErGw3AZ** Sku.
