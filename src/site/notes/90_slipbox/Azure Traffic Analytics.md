---
{"dg-publish":true,"dg-path":"Slipbox Notes/Azure Traffic Analytics.md","permalink":"/slipbox-notes/azure-traffic-analytics/","tags":["notes"],"created":"2024-10-21","updated":"2025-11-28"}
---
...
- **Log Analytics** - An Azure service that collects monitoring data and stores the data in a central repository. This data can include events, performance data, or custom data provided through the Azure API. Once collected, the data is available for alerting, analysis, and export. Monitoring applications such as network performance monitor and traffic analytics are built using Azure Monitor logs as a foundation. For more information, see [[90_slipbox/Azure Log Analytics Workspace\|Azure Log Analytics Workspace]]
