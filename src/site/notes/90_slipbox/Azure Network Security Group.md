---
{"dg-publish":true,"dg-path":"Slipbox Notes/Azure Network Security Group.md","permalink":"/slipbox-notes/azure-network-security-group/","tags":["notes"],"created":"2023-05-26","updated":"2026-03-03","dg-note-properties":{"created":"2023-05-26","modified":"2026-03-03","tags":"notes","related":["[[Azure]]"]}}
---
...
[^1]  
NSG's can also be used to target [[90_slipbox/Azure Application Security Groups\|Azure Application Security Groups]], which allows for the targeting of NICS bundled as a application, rather than targeting a set of IP addresses.
...
Network Security Groups can be assigned to [[90_slipbox/Azure Subnet\|Subnets]] and Azure Network Interface Card (NICs).  
