---
{"dg-publish":true,"dg-path":"Slipbox Notes/Routing in Azure.md","permalink":"/slipbox-notes/routing-in-azure/","tags":["notes"],"created":"2023-08-02","updated":"2026-03-03","dg-note-properties":{"tags":"notes","related":["[[Azure Virtual Network]]","[[Azure]]","[[Network Administration]]"],"created":"2023-08-02","modified":"2026-03-03"}}
---
...
When declaring [[90_slipbox/Azure Virtual Network\|Virtual Networks]], you are unable to do so if the new VNET Address Space overlaps with any VNET in the mesh of VNETS that you are trying to peer it into.
...
[[90_slipbox/Border Gateway Protocol\|Border Gateway Protocol]] is implemented in Azure, either managed by a [[90_slipbox/Azure Route Server\|Azure Route Server]] or being propagated from on-premises using a [[90_slipbox/Azure Virtual Network Gateway\|Azure Virtual Network Gateway]].
...
When you configure VNET Peering, they typically automatically learn routes about each other. In a typical Hub and Spoke topology, the desire is to route all traffic through the [[90_slipbox/Azure Firewall\|Azure Firewall]].
...
When using a [[90_slipbox/Azure Virtual Network Gateway\|Azure Virtual Network Gateway]], you must put a Route Table on the *GatewaySubnet* that has routes for the Hub and each Spoke to use the Firewall, but you can not add a **0.0.0.0/0** route to this subnet.
...
- [[90_slipbox/Network Routing\|Network Routing]]
