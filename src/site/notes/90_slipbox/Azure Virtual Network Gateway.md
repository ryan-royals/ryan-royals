---
{"dg-publish":true,"permalink":"/90-slipbox/azure-virtual-network-gateway/","tags":["notes"],"created":"2026-03-27T09:57:51.488+10:30","updated":"2026-06-11T09:30:38.356+09:30","dg-note-properties":{"created":"2023-08-11","modified":"2026-06-11","references":["https://learn.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-about-vpngateways"],"related":["[[90_slipbox/Azure Local Network Gateway\|Azure Local Network Gateway]]","[[Azure]]"],"tags":"notes"}}
---
...
Azure VPN Gateway is used to create a [[90_slipbox/Virtual Private Network\|Virtual Private Network]] connections as either [[90_slipbox/Virtual Private Network#Point to Site\|Point-to-Site]], [[90_slipbox/Virtual Private Network#Site to Site\|Site-to-Site]] or Vnet-to-Vnet to a [[90_slipbox/Azure Virtual Network\|Azure Virtual Network]] via [[90_slipbox/IPSec\|IPSec]].

### Azure Resource Architecture

To connect a VPN to another network, several sub resources are deployed to store information.  
![Azure Virtual Network Gateway-1716082799506.png](/img/user/10_attachments/Azure%20Virtual%20Network%20Gateway-1716082799506.png)
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/90-slipbox/azure-local-network-gateway/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/90-slipbox/azure-connection/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
![Azure Virtual Network Gateway-1714955234905.png](/img/user/10_attachments/Azure%20Virtual%20Network%20Gateway-1714955234905.png)  
...
3. [[90_slipbox/Border Gateway Protocol\|BGP]] is required for this configuration. Each local network gateway representing a VPN device must have a unique BGP peer IP address specified in the Bgp PeerIpAddress property.
...
![Azure Virtual Network Gateway-1714955747883.png](/img/user/10_attachments/Azure%20Virtual%20Network%20Gateway-1714955747883.png)  
...
![Azure Virtual Network Gateway-1714956278426.png](/img/user/10_attachments/Azure%20Virtual%20Network%20Gateway-1714956278426.png)  
...
#### [[90_slipbox/Use Azure DNS Private Resolver over Azure VPN\|Use Azure DNS Private Resolver over Azure VPN]]
...
Use [[90_slipbox/Azure Monitor\|Azure Monitor]] to analyse the data collected in the diagnostic logs.

## Express Route Gateway

An Virtual Network Gateway can be configured as a [[90_slipbox/Azure ExpressRoute\|Azure ExpressRoute]] Gateway.

## Footnotes

[^1]: [About ExpressRoute Virtual Network Gateways](https://learn.microsoft.com/en-gb/azure/expressroute/expressroute-about-virtual-network-gateways#gatewayfeaturesupport)
