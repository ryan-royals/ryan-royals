...
* [Create a user-defined route table with routes and a network virtual appliance](https://learn.microsoft.com/en-us/azure/virtual-network/tutorial-create-route-table-portal)
