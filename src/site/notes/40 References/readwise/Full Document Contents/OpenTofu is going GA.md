---
{"dg-publish":true,"permalink":"/40-references/readwise/full-document-contents/open-tofu-is-going-ga/","tags":["rw/articles"]}
---

![rw-book-cover](https://opentofu.org/img/blog/opentofu-is-going-ga.png)

![OpenTofu is going GA](https://opentofu.org/img/blog/opentofu-is-going-ga.png)
...
[![A screenshot of the client-side state encryption RFC GitHub issue](https://opentofu.org/img/blog/opentofu-is-going-ga-client-side-state-encryption.png)](https://github.com/opentofu/opentofu/issues/874)[A screenshot of the client-side state encryption RFC GitHub issue](https://github.com/opentofu/opentofu/issues/874)
**Parameterizable backends, providers, and modules** have been a very common community request, e.g. parameterizing module versions using variables, maybe even instantiating providers using for\_each parameters on a static list of values. This is something we’re looking into and hope to introduce an answer for eventually.
