---
{"dg-publish":true,"permalink":"/40-references/readwise/full-document-contents/about-virtual-hub-settings-azure-virtual-wan/","tags":["rw/articles"]}
---
...
1. [Virtual hub capacity](https://learn.microsoft.com/en-us/azure/virtual-wan/hub-settings#capacity)
2. [Virtual hub routing preference](https://learn.microsoft.com/en-us/azure/virtual-wan/hub-settings#routing-preference)
3. [Gateway settings](https://learn.microsoft.com/en-us/azure/virtual-wan/hub-settings#gateway)
4. [Basic and Standard](https://learn.microsoft.com/en-us/azure/virtual-wan/hub-settings#type)
5. [Virtual hub router status](https://learn.microsoft.com/en-us/azure/virtual-wan/hub-settings#router-status)
6. [Next steps](https://learn.microsoft.com/en-us/azure/virtual-wan/hub-settings#next-steps)
...
A virtual hub can contain gateways for site-to-site VPN, ExpressRoute, or point-to-site User VPN. For example, when using Virtual WAN, you don't create a site-to-site connection from your on-premises site directly to your VNet. Instead, you create a site-to-site connection to the virtual hub. The traffic always goes through the virtual hub gateway. This means that your VNets don't need their own virtual network gateway. Virtual WAN lets your VNets take advantage of scaling easily through the virtual hub and the virtual hub gateway. For more information about gateways, see [Gateway settings](https://learn.microsoft.com/en-us/azure/virtual-wan/gateway-settings). Note that a virtual hub gateway isn't the same as a virtual network gateway that you use for ExpressRoute and VPN Gateway.
...
![Screenshot shows capacity.](https://learn.microsoft.com/en-us/azure/virtual-wan/media/hub-settings/basics-hub.png)
...
| Routing infrastructure unit | Aggregate throughputGbps | Number of VMs |
| --- | --- | --- |
| 2 | 3 | 2000 |
| 3 | 3 | 3000 |
| 4 | 4 | 4000 |
...
For more information, see [About virtual hub routing preference](https://learn.microsoft.com/en-us/azure/virtual-wan/about-virtual-hub-routing-preference).
...
For more information about gateway settings, see [Gateway settings](https://learn.microsoft.com/en-us/azure/virtual-wan/gateway-settings).

#### Basic and Standard

The virtual WAN type (Basic or Standard) determines the types of resources that can be created within a virtual hub, including the type of gateways that can be created (site-to-site VPN, point-to site User VPN, and ExpressRoute). This setting is configured on the virtual WAN object. For more information, see [Upgrade from Basic to Standard](https://learn.microsoft.com/en-us/azure/virtual-wan/upgrade-virtual-wan).
...
| Standard | Standard | ExpressRouteUser VPN (P2S)VPN (site-to-site) Inter-hub and VNet-to-VNet transiting through the virtual hub Azure Firewall NVA in a virtual WAN |
...
For virtual hub routing, see [About virtual hub routing](https://learn.microsoft.com/en-us/azure/virtual-wan/about-virtual-hub-routing).
